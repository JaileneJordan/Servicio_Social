<?php session_start();
  ...
  $consulta = ConsultarMateria($_GET['id']);
  $id1=$_GET['id'];

  function ConsultarMateria($id){
    $conn=new mysqli('localhost', 'root', '', 'asesorias_successfull');
    $sentencia = "SELECT * FROM materia WHERE id_materia='".$id."'";
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form  data-parsley-validate class="form-horizontal form-label-left" method="POST" action="adminModificarMateria.php" enctype="multipart/form-data">

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="id" >Id Materia <span class="required">*</span>
                        </label>
                        <div class="col-md-3" >
