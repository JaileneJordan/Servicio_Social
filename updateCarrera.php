<?php session_start();
  ...
  $consulta = ConsultarCarrera($_GET['id']);

  function ConsultarCarrera($id){
    $conn=new mysqli('localhost', 'root', '', 'asesorias_successfull');
    $sentencia = "SELECT * FROM carrera WHERE id_carrera='".$id."'";
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form  data-parsley-validate class="form-horizontal form-label-left" method="POST" action="adminModificarCarrera.php" enctype="multipart/form-data">

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="id" >Id Carrera <span class="required">*</span>
                        </label>
                        <div class="col-md-3" >
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nombre" >Carrera <span class="required">*</span>
                        </label>
                        <div class="col-md-3" >
