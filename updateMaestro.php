<?php session_start();
  ...
  $consulta = ConsultarMaestro($_GET['id']);

  function ConsultarMaestro($id){
    $conn=new mysqli('localhost', 'root', '', 'asesorias_successfull');
    $sentencia = "SELECT * FROM maestro WHERE matricula_maestro='".$id."'";
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form  data-parsley-validate class="form-horizontal form-label-left" method="POST" action="adminModificarMaestro.php" enctype="multipart/form-data">

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="id" >Matricula Maestro <span class="required">*</span>
                        </label>
                        <div class="col-md-3" >
                          <input type="hidden" name="id" id="id">
                          <input type="text" name="id" id="id"  value="<?php echo $consulta[0]; ?>"><br>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nombre" >Apellido Paterno <span class="required">*</span>
                        </label>
                        <div class="col-md-3" >
                          <input type="text" name="ap" id="ap"  value="<?php echo $consulta[2]; ?>"><br>
                        </div>
                      </div>

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nombre" >Apellido Materno <span class="required">*</span>
                        </label>
                        <div class="col-md-3" >
                          <input type="text" name="am" id="am"  value="<?php echo $consulta[3]; ?>"><br>
                        </div>
                      </div>
