              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="insertcarrera.php" enctype="multipart/form-data">
                       ...
                       $conn = new mysqli($servername, $username, $password, $dbname);
                         ...
                         $row[0];?>
                                   ...
                                   <td>
                                     <?PHP
                                     $id = $row[0];
                                     echo "<a href='updateCarrera.php?id=".$id."'><button type='submit' class='btn btn-primary'>Editar</button></a>";
                                     echo "<a href='deleteCarrera.php?id=".$id."'> <button type='submit' class='btn btn-danger'>Eliminar</button></a>";
                                     ?>
