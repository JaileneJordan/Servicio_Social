           ...
           <div class="col-md-12 col-sm-12 col-xs-12">
               ...
               <?PHP
                 ...
                 $conn = new mysqli($servername, $username, $password, $dbname);
                       $query= 'select alumno.matricula,alumno.nombre,alumno.apellido_paterno,alumno.apellido_materno,alumno.id_grupo,carrera.nombre FROM alumno INNER JOIN carrera where alumno.id_carrera=carrera.id_carrera';
                   ...
                   $row[0];?>
                             ...
                             <td>
                               <?PHP
                               $id = $row[0];
                               echo "<a href='updateAlumno.php?id=".$id."'><button type='submit' class='btn btn-primary'>Editar</button></a>";
                               echo "<a href='deleteAlumno.php?id=".$id."'> <button type='submit' class='btn btn-danger'>Eliminar</button></a>";
                               ?>
