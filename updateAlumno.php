<?php session_start();
  ...
  $consulta = ConsultarAlumno($_GET['id']);

  function ConsultarAlumno($id){
    $conn=new mysqli('localhost', 'root', '', 'asesorias_successfull');
    $sentencia = "SELECT * FROM alumno WHERE matricula='".$id."'";
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form  data-parsley-validate class="form-horizontal form-label-left" method="POST" action="adminModificarAlumno.php" enctype="multipart/form-data">

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="id" >Matricula <span class="required">*</span>
                        </label>
                        <div class="col-md-3" >
                        ...
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="id_carrera">Carrera <span class="required">*</span>
                          ...
                          <div class="col-md-3">
                            <select class="form-control" name="id_carrera">
                              <option selected ><?php echo $consulta[5]; ?></option>
                              <?php
                                $mysqli = new mysqli('localhost', 'root', '', 'asesorias_successfull');
